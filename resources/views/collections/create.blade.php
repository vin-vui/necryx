        ...
        <form action="{{ route('collections.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="pb-5">
                ...
                <div class=" text-black">
                    <input type="text" name="name" class="w-full focus:ring-2 ring-1 ring-gray-50 border-0 ring-inset focus:ring-inset focus:ring-yellow-400" value="{{ old('name') }}">
                </div>
            </div>
            <div class="pb-5">
            ...
            <div class="pb-5">
                ...
                <div class=" text-black">
                    <textarea class="w-full focus:ring-2 ring-1 ring-gray-50 border-0 ring-inset focus:ring-inset focus:ring-yellow-400 " name="content" cols="30" rows="10">{{ old('content') }}</textarea>
                </div>
            </div>
            <div class="flex justify-between gap-4">
                <div class="pb-5 w-full">
                    ...
                    <div class=" text-black">
                        <input type="text" name="players" class="w-full focus:ring-2 ring-1 ring-gray-50 border-0 ring-inset focus:ring-inset focus:ring-yellow-400 " value="{{ old('players') }}">
                    </div>
                </div>
                <div class="pb-5 w-full">
                    <label class="font-bold text-lg">Durée</label>
                    <div class=" text-black">
                        <input type="text" name="duration" class=" w-full focus:ring-2 ring-1 ring-gray-50 border-0 ring-inset focus:ring-inset focus:ring-yellow-400 " value="{{ old('duration') }}">
                    </div>
                </div>
                <div class="pb-5 w-full">
                    <label class="font-bold text-lg">Age</label>
                    <div class=" text-black">
                        <input type="text" name="age" class=" w-full focus:ring-2 ring-1 ring-gray-50 border-0 ring-inset focus:ring-inset focus:ring-yellow-400 " value="{{ old('age') }}">
                    </div>
                </div>
            </div>
            <div class="pb-5">
                ...
                <div class=" text-black">
                    <textarea class="w-full focus:ring-2 ring-1 ring-gray-50 border-0 ring-inset focus:ring-inset focus:ring-yellow-400 " name="origin" cols="30" rows="5">{{ old('origin') }}</textarea>
                </div>
            </div>
            <div class="pb-5 ">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <div class="bg-gray-50 text-gray-900 py-1 px-2">
                        <input id="tag_{{ $tag->id }}" type="checkbox" name="tags[]" value="{{ $tag->id }}" class="text-yellow-400 focus:ring-yellow-400">
