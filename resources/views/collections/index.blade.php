            ...
            <tbody>
                ...
                <tr class="border-b bg-gray-800 border-gray-700">
                    ...
                    <td class="px-6 text-center">
                        <span class="bg-yellow-400 text-gray-900 py-0.5 px-2 rounded-tl-md rounded-br-md">{{ $collection->type != null ? $collection->type->name : 'N/A' }} ({{ $collection->type != null ? $collection->type->id : 'null' }})</span>
                    </td>
