<x-app-layout>
    ...
    <div class="fixed right-4 top-4 z-50">
        <a class="hover:drop-shadow-[0px_0px_19px_#D0A302] bg-yellow-400 hover:bg-yellow-500 transition-all font-p text-xs uppercase tracking-widest inline-flex justify-center items-center gap-2 py-3 px-4 text-center text-gray-900" href="{{ route('articles.create') }}">
        ...
        <table class="w-full text-sm text-left text-gray-400">
            ...
            <tbody>
                ...
                <tr class="border-b bg-gray-800 border-gray-700">
                    <td class="px-6 py-2">
                        <img class="h-16 w-auto object-cover" src="{{ Storage::url($article->image) }}" alt="">
                    </td>
                    ...
                    <td class="px-6 font-medium whitespace-nowrap">
                        <div class="flex items-end justify-end">
                            <a class="btn btn-primary pr-2 class=font-medium text-blue-500 hover:underline" href="{{ route('articles.edit', $article->id) }}">Editer</a>
