                        ...
                        <li>
                            ...
                            <div id="dropdownNavbar"
                                ...
                                <ul class="mt-4 py-2 text-sm dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                    <li class="block px-4 py-2 font-necryx text-onyx">Jeux</a>
                                    </li>
                                    <li class="block px-4 py-2 font-necryx text-onyx">Concepts</a>
                                    </li>
                                    <li class="block px-4 py-2 font-necryx text-onyx">Art</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
