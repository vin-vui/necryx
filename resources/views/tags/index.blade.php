<x-app-layout>
    ...
    <div class="m-10">
        <div class="pb-8 flex justify-around items-center">
            ...
            <a class="border-4 border-gray-800 bg-gray-800 text-white rounded-xl p-2" href="{{ route('tags.create') }}">
                Ajouter un tag</a>
                                ...
                                <td>
                                    <form action="{{ route('tags.destroy', $tag->id) }}" method="POST">
                                        ...
                                        <a class="btn btn-info pr-2 class=font-medium text-green-600 dark:text-green-500 hover:underline"
                                            href="{{ route('tags.show', $tag->id) }}">Voir</a>
