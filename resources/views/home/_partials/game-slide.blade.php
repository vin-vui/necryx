<div class="swiper-slide relative backdrop-blur-sm bg-black/80 sm:pb-24 xl:pb-0">
    <div class="mx-auto xl:flex max-w-7xl items-center gap-y-8 px-4 lg:px-8 xl:flex-row xl:items-stretch">
        <div class="flex justify-center md:block mx-auto max-w-7xl xl:w-96 md:-mt-4">
        ...
        <div class="max-w-2xl xl:max-w-none flex xl:px-16 py-6 flex-col md:mt-0 mt-40">
            <div class="xl:w-[40rem] text-extrabold text-seasalt leading-8 font-h1 sm:text-3xl text-xl sm:leading-9">
                {{ $game->name }}
            </div>
            <div class="my-6 text-sm font-p">
                <div class="mt-1 flex flex-col md:justify-between gap-y-4 border-l-2 pl-4">
                    <div class="">
                        <div class="text-md text-seasalt font-h2">Nombre de joueurs</div>
                        <div class="">
                            <span class="font-h2 py-0.5 px-3 bg-gradient-to-br from-yellow-300 to-yellow-700 rounded-tl-xl rounded-br-xl text-gray-900 font-semibold">
                                {{ $game->players }}
                            </span>
                        </div>
                    </div>
                    <div class="">
                        <div class="text-md text-seasalt font-h2">Durée</div>
                        <div class="">
                            <span class="font-h2 py-0.5 px-3 bg-gradient-to-br from-yellow-300 to-yellow-700 rounded-tl-xl rounded-br-xl text-gray-900 font-semibold">
                                {{ $game->duration }}
                            </span>
                    ...
                    <div class="">
                        <div class="text-md text-seasalt font-h2 capitalize">âge</div>
                        <div class="">
                            <span class="py-0.5 px-3 font-h2 bg-gradient-to-br from-yellow-300 to-yellow-700 rounded-tl-xl rounded-br-xl text-gray-900 font-semibold">
                                {{ $game->age }}
                            </span>
                        </div>
                    </div>
