<a href="{{ route('home') }}" class="text-sm font-semibold leading-6 font-p text-white pb-2 mt-2 border-b-2 border-transparent hover:border-white transition-all {{ request()->routeIs('home') ? 'border-yellow-400' : '' }}">
    Accueil
</a>
...
<div class="md:hidden flex text-sm font-semibold leading-6 font-p text-white pb-2 mt-2 border-b-2 border-transparent hover:border-white transition-all {{ request()->routeIs('collections') ? 'border-yellow-400' : '' }}">
    Collections
</div>
