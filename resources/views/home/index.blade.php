...
<div class="flex flex-col gap-y-10">
    <div class="relative bg-black py-2">
        ...
        <div class="flex flex-col w-auto lg:flex-row justify-around gap-x-20 mx-24 absolute top-2/4 mt-16 z-50 h-auto ">
                        ...
                        <div
                            ...
                            <div class="-mt-8 max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                                <div class="relative aspect-[2/1] h-96 md:-mx-8 xl:mx-0 xl:aspect-auto">
                                    <img class="inset-0 h-full rounded-2xl bg-gray-800 shadow-2xl"
                                        src="{{ Storage::url($collection->image) }}" alt="{{ $collection->name }}">
                                </div>
                            </div>
                            <div class="max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                                <div
                                    class="truncate w-[40rem] text-xs text-seasalt leading-8 font-p lg:text-xl sm:leading-9">
                                    {{ $collection->content }}
                                </div>
        ...
        <div class="relative mt-44 bg-gray-50 px-6 pb-20 pt-16 lg:px-8 lg:pb-28 lg:pt-24">
            ...
            <div class="relative mx-auto max-w-7xl">
                ...
                <div class="mx-auto mt-12 grid max-w-lg gap-5 font-p lg:max-w-none lg:grid-cols-3">
                    ...
                    @endif
                    <div
                        class="flex flex-col overflow-hidden rounded-lg shadow-lg group hover:scale-105 transition duration-300">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-full group-hover:opacity-80 duration-300"
                                ...
                                <div class="flex-shrink-0">
                                    <div>
                                        ...
                                        <img class="h-10 w-10 rounded-full"
                                            src="{{ Storage::url($article->type->image) }}" alt="">
                                    </div>
                                </div>
                                <div class="ml-3">
            ...
            <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                    <img class="absolute inset-0 h-full w-full rounded-2xl bg-gray-800 object-cover shadow-2xl"
                        src="{{ Storage::url('Photo_Profil.jpg') }}"
                        alt="">
                </div>
            </div>
        </div>
