<x-guest-layout>
    <div class="relative bg-seasalt">
        <div class="mx-auto max-w-7xl lg:flex lg:flex-row-reverse lg:justify-between lg:px-8 xl:justify-end">
            ...
            <div class="lg:flex lg:w-1/2 lg:shrink lg:grow-0 xl:absolute xl:inset-y-0 xl:left-1/2 xl:w-1/2">
                <div class="relative h-80 lg:-ml-8 lg:h-auto lg:w-full lg:grow xl:ml-0">
                    <img class="absolute inset-0 h-full w-full bg-gray-50 object-cover rounded-xl" src="https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-x=.4&w=2560&h=3413&&q=80" alt="">
                </div>
            </div>
        </div>
    </div>
    <div class="relative isolate bg-seasalt mt-12">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            ...
            <form action="{{ route('contact-form') }}" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
                @csrf
            <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit" class="rounded-md bg-dark-red px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-dark-red/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Envoyer</button>
                    </div>
                </div>
            </form>
        </div>
